...
replace({
  ...
  replacement:
    'odk_forum_summary">Join the forum to get support and connect with other users!<',
...
replace({
  ...
  paths: [
    "collect_app/src/main/java/org/odk/collect/android/activities/AboutActivity.kt",
    "strings/src/main/res",
  ],
  recursive: true,
  silent: true,
});
...
replace({
  ...
  replacement:
    'odk_website_summary">KoboCollect is part of KoboToolbox and based on ODK Collect.<',
  paths: ["strings/src/main/res"],
  recursive: true,
  silent: true,
});
